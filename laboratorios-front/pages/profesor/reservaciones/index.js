        ...
        onConfirm: () => {
          return this.$axios
            ...
            .then((response) => {
              ...
              // 👇 Aquí mostramos el toast popup si el backend dice "hay mensaje"
              if (response.data.popup) {
                this.$bvToast.toast('Tienes un nuevo mensaje en tu bandeja de entrada.', {
                  title: '📩 Nuevo mensaje',
                  variant: 'info',
                  autoHideDelay: 0,
                  noAutoHide: true,
                ...
                this.$root.$emit('mensaje-nuevo'); // 🔴 activa el círculo rojo visual

                // Opcional: recarga contador de badge
