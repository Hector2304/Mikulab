...
class ExternoCursoAlta extends BaseHandler
{
	public function handle()
	{
		try {
			...
			$cursoDTO->setCuexIdCursoExterno($cursoDAO->alta($cursoDTO));

			RestCommons::respondWithStatus(200, $cursoDTO->getObjectVars());
		} catch (Exception $e) {
