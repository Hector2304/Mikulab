...
class LaboratoriosBloqHorarioDeleteOne extends BaseHandler
{
	public function handle()
	{
		try {
			...
			$bloqDAO->bajaIndividual($jsonData->fecha, $jsonData->hora, $jsonData->labId);
...
(new RESTEndpointClient(array('DELETE'), array(TipoUsuarioEnum::SUPERUSUARIO)))
	->execute(new LaboratoriosBloqHorarioDeleteOne);
