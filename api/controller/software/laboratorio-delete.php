...
class SoftwareLaboratorioDelete extends BaseHandler
{
	public function handle()
	{
		try {
			...
			$softwareDAO->removerDeLaboratorio($jsonData->idLaboratorio, $jsonData->idSoftware);
...
(new RESTEndpointClient(array('DELETE'), array(TipoUsuarioEnum::SUPERUSUARIO)))
	->execute(new SoftwareLaboratorioDelete);
